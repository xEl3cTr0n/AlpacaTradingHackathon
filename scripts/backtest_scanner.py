#!/usr/bin/env python3
"""Reproduce the large-cap 18 EMA scanner's chronological validation."""
...
from regimeshift.domain.scanner_backtest import ScannerBacktester  # noqa: E402
...
def main() -> int:
    ...
    report = ScannerBacktester().evaluate(histories)
    report.update(
        {
            ...
            "source": (
                ...
                if args.demo
                else "Alpaca IEX fully adjusted daily bars"
            ),
            "history": {
