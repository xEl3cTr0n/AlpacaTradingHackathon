#!/usr/bin/env python3
"""Calibrate the potential-move range on Alpaca daily bars."""
...
from regimeshift.domain.potential_move_backtest import PotentialMoveBacktester  # noqa: E402
...
def main() -> int:
    ...
    report = PotentialMoveBacktester().evaluate(histories)
    report.update(
        {
